      ...
      <div className='bg-white shadow-lg rounded-lg p-0 pb-12 mb-8 lg:p-8'>
         ...
         <div className='relative overflow-hidden shadow-md pb-80 mb-6'>
            <img src={post.featuredImage.url} alt={post.title}
               className='object-top absolute h-70 w-full object-cover
               shadow-lg rounded-t-lg lg:rounded-lg'
            />
         </div>

         <h1 className='transition duration-200 text-center mb-8
         ...
         <p className='text-center text-lg text-gray-700 font-normal px-5
            lg:px-10 mb-8'
         >
            {post.excerpt}
         </p>
         ...
         <div className='text-center '>
            <Link href={'/post/' + post.slug}>
               <span className='transition duration-200 transform
                  hover:-translate-y-1 inline-block bg-pink-600 text-lg
                  font-medium rounded-full text-white px-8 py-3
                  cursor-pointer'
               >
                  Continue Reading
               </span>
